...
pnpm drafts:run-work-orders -- --sandbox-base-url http://localhost:3020 --api-key sandbox-secret --automation-endpoint https://automation.example.com/drafts --automation-api-key "$AUTOMATION_API_KEY" --require-automation --once
